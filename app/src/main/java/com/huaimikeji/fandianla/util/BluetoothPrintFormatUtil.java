...
public class BluetoothPrintFormatUtil {
    ...
    /**
     * 排版居中内容(以':'对齐) 例：姓名：李白 病区：5A病区 住院号：11111
     *
     * @param msg
     * @return
     */
    ...
    /**
     * 排版左右对称内容(以':'对齐) 例：姓名：李白 住院号：111111 病区：5A病区 科室：五官科 体重：130kg
     *
    ...
    /**
     * 打印订餐单 (左中右对称) 例: 菜名 数量 单价 早餐： 豆沙包 1 3.0 蛋 1 1.5 午餐： 包子 3 11.0 晚餐： 土豆 2
     * 4.1
     *
